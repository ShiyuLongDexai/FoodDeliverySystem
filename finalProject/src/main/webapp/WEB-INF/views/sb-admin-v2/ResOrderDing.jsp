...
<body>
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Delivering Order</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-info">
                       ...
                       <a  href="ResOrderUD">Undelivered Order &lt;&lt;</a>
						...
						<div class="panel-body">
							...
							<center><table  class="table table-striped table-bordered table-hover"
								...
								<c:forEach items="${orders}" var="foodOrder">
									<tr>
										<form method="post" action="ResOrderDing">
											...
											<td>
											<input type='submit' class="btn btn-default" value='arrive' />
											</form>
