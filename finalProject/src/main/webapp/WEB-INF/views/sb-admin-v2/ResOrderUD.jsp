...
<body>
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Current Food Order</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
				...
				<div class="col-lg-12">
					<div class="panel panel-info">
						<div class="panel-heading" align="right"> 
                         ...
                         &nbsp;&nbsp;&nbsp;<a  href="ResOrderDed">Delivered Order &gt;&gt;</a>
						...
						<div class="panel-body">
							...
							<center><table class="table table-striped table-bordered table-hover"
								...
								<thead>
									<tr>
										<th  width="5%">#</th>
										<th  width="15%">Order Date</th><th  width="12%">Delivery</th>
								...
								<c:forEach items="${orders}" var="foodOrder">
									<tr>
										<form method="post" action="ResOrderUD">
											...
											<td>
											<input style="height:80%" type='submit' class="btn btn-default" value='deliver' />
											</form>
